...
| `apps/client/public/assets/world/world.png`, `world.json` (fills, props) | Kenney (www.kenney.nl) | https://kenney.nl/assets/tiny-dungeon (`kenney_tiny-dungeon.zip`, 98 kB, Tiny Dungeon 1.0, 2022) | **CC0 1.0**. Read from the zip's own `License.txt` ("free to use in personal, educational and commercial projects"; crediting Kenney is not mandatory) and matching the download page. | 2026-09-21 | No (credit appreciated; the credits page names Kenney) | Yes: eight props and five fills cut from `Tilemap/tilemap_packed.png` (indices in `art/world/README.md`); Kenney's outline `#3f2631` recoloured to `#1a0e13` in props; ten pixels added to the flat dirt tile. Packed by `art/world/build_atlas.py`. |
